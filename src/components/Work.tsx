...
const projects = [
  {
    title: "ClaimFlow AI",
    category: "Intelligent Claims Processing (PM Project)",
    tools:
      "Agentic triage concept, dashboard UX, claim metrics, recommended next steps",
    image: "/images/claimflow.png",
    link: "https://sharry2205.github.io/EMA-APM-Project/",
  },
  {
